        ...
        <div className="px-6 py-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap justify-end gap-3">
            <button
              ...
              className="rounded-full border border-amber-900/20 bg-white px-5 py-2.5 font-rubik text-amber-900 transition hover:bg-amber-50 disabled:cursor-not-allowed disabled:opacity-70 cursor-pointer"
            >
              {cancelLabel}
            </button>
            <button
              ...
              onClick={onConfirm}
              disabled={isConfirming}
              className="rounded-full bg-red-700 px-5 py-2.5 font-rubik text-white transition hover:bg-red-800 disabled:cursor-not-allowed disabled:opacity-70 cursor-pointer"
            >
